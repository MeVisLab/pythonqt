...
bool  PythonQtWrapper_QAbstractProxyModel::canDropMimeData(QAbstractProxyModel* theWrappedObject, const QMimeData*  data, Qt::DropAction  action, int  row, int  column, const QModelIndex&  parent) const
{
  return ( ((PythonQtPublicPromoter_QAbstractProxyModel*)theWrappedObject)->promoted_canDropMimeData(data, action, row, column, parent));
}
...
bool  PythonQtWrapper_QAbstractProxyModel::dropMimeData(QAbstractProxyModel* theWrappedObject, const QMimeData*  data, Qt::DropAction  action, int  row, int  column, const QModelIndex&  parent)
{
  return ( ((PythonQtPublicPromoter_QAbstractProxyModel*)theWrappedObject)->promoted_dropMimeData(data, action, row, column, parent));
}
...
Qt::DropActions  PythonQtWrapper_QAbstractProxyModel::supportedDragActions(QAbstractProxyModel* theWrappedObject) const
{
  return ( ((PythonQtPublicPromoter_QAbstractProxyModel*)theWrappedObject)->promoted_supportedDragActions());
}
