...
void PythonQtWrapper_QTabBar::timerEvent(QTabBar* theWrappedObject, QTimerEvent*  event)
{
  ( ((PythonQtPublicPromoter_QTabBar*)theWrappedObject)->promoted_timerEvent(event));
}
