...
{ public:
inline void paintGL() { QGLWidget::paintGL(); }
inline bool  event(QEvent*  arg__1) { return QGLWidget::event(arg__1); }
inline void paintOverlayGL() { QGLWidget::paintOverlayGL(); }
inline void resizeOverlayGL(int  w, int  h) { QGLWidget::resizeOverlayGL(w, h); }
inline void glDraw() { QGLWidget::glDraw(); }
inline void glInit() { QGLWidget::glInit(); }
inline void initializeGL() { QGLWidget::initializeGL(); }
inline void paintEvent(QPaintEvent*  arg__1) { QGLWidget::paintEvent(arg__1); }
inline void resizeEvent(QResizeEvent*  arg__1) { QGLWidget::resizeEvent(arg__1); }
inline void resizeGL(int  w, int  h) { QGLWidget::resizeGL(w, h); }
inline void initializeOverlayGL() { QGLWidget::initializeOverlayGL(); }
};
