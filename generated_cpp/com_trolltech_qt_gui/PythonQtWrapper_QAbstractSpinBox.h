...
{ public:
inline void keyPressEvent(QKeyEvent*  event) { QAbstractSpinBox::keyPressEvent(event); }
inline void mousePressEvent(QMouseEvent*  event) { QAbstractSpinBox::mousePressEvent(event); }
inline void paintEvent(QPaintEvent*  event) { QAbstractSpinBox::paintEvent(event); }
inline void focusOutEvent(QFocusEvent*  event) { QAbstractSpinBox::focusOutEvent(event); }
inline void mouseReleaseEvent(QMouseEvent*  event) { QAbstractSpinBox::mouseReleaseEvent(event); }
inline void contextMenuEvent(QContextMenuEvent*  event) { QAbstractSpinBox::contextMenuEvent(event); }
inline void mouseMoveEvent(QMouseEvent*  event) { QAbstractSpinBox::mouseMoveEvent(event); }
inline void keyReleaseEvent(QKeyEvent*  event) { QAbstractSpinBox::keyReleaseEvent(event); }
inline void showEvent(QShowEvent*  event) { QAbstractSpinBox::showEvent(event); }
inline void wheelEvent(QWheelEvent*  event) { QAbstractSpinBox::wheelEvent(event); }
inline void closeEvent(QCloseEvent*  event) { QAbstractSpinBox::closeEvent(event); }
inline void resizeEvent(QResizeEvent*  event) { QAbstractSpinBox::resizeEvent(event); }
inline QAbstractSpinBox::StepEnabled  stepEnabled() const { return QAbstractSpinBox::stepEnabled(); }
inline void hideEvent(QHideEvent*  event) { QAbstractSpinBox::hideEvent(event); }
inline void changeEvent(QEvent*  event) { QAbstractSpinBox::changeEvent(event); }
inline void timerEvent(QTimerEvent*  event) { QAbstractSpinBox::timerEvent(event); }
inline void focusInEvent(QFocusEvent*  event) { QAbstractSpinBox::focusInEvent(event); }
};
