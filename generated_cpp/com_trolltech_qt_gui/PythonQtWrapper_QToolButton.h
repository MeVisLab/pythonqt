...
{ public:
inline void nextCheckState() { QToolButton::nextCheckState(); }
inline bool  event(QEvent*  e) { return QToolButton::event(e); }
inline bool  hitButton(const QPoint&  pos) const { return QToolButton::hitButton(pos); }
inline void enterEvent(QEvent*  arg__1) { QToolButton::enterEvent(arg__1); }
inline void timerEvent(QTimerEvent*  arg__1) { QToolButton::timerEvent(arg__1); }
inline void actionEvent(QActionEvent*  arg__1) { QToolButton::actionEvent(arg__1); }
inline void paintEvent(QPaintEvent*  arg__1) { QToolButton::paintEvent(arg__1); }
inline void changeEvent(QEvent*  arg__1) { QToolButton::changeEvent(arg__1); }
inline void mouseReleaseEvent(QMouseEvent*  arg__1) { QToolButton::mouseReleaseEvent(arg__1); }
inline void leaveEvent(QEvent*  arg__1) { QToolButton::leaveEvent(arg__1); }
inline void mousePressEvent(QMouseEvent*  arg__1) { QToolButton::mousePressEvent(arg__1); }
};
