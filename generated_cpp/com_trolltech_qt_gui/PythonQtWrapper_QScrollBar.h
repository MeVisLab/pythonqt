...
{ public:
inline void mousePressEvent(QMouseEvent*  arg__1) { QScrollBar::mousePressEvent(arg__1); }
inline void mouseReleaseEvent(QMouseEvent*  arg__1) { QScrollBar::mouseReleaseEvent(arg__1); }
inline void contextMenuEvent(QContextMenuEvent*  arg__1) { QScrollBar::contextMenuEvent(arg__1); }
inline void mouseMoveEvent(QMouseEvent*  arg__1) { QScrollBar::mouseMoveEvent(arg__1); }
inline void hideEvent(QHideEvent*  arg__1) { QScrollBar::hideEvent(arg__1); }
inline void paintEvent(QPaintEvent*  arg__1) { QScrollBar::paintEvent(arg__1); }
};
