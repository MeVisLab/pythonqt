...
{
return  (*((PythonQtPublicPromoter_QTextDocument*)theWrappedObject)).createObject(f);
}
...
{
return  (*((PythonQtPublicPromoter_QTextDocument*)theWrappedObject)).loadResource(type, name);
}
