...
inline void promoted_insertItem(int  index, QLayoutItem*  arg__2) { QBoxLayout::insertItem(index, arg__2); }
...
inline QIcon  promoted_standardIconImplementation(QStyle::StandardPixmap  standardIcon, const QStyleOption*  opt = 0, const QWidget*  widget = 0) const { return QCDEStyle::standardIconImplementation(standardIcon, opt, widget); }
...
inline QIcon  promoted_standardIconImplementation(QStyle::StandardPixmap  standardIcon, const QStyleOption*  option, const QWidget*  widget = 0) const { return QCleanlooksStyle::standardIconImplementation(standardIcon, option, widget); }
