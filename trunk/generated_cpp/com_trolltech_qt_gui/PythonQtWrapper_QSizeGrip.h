...
{ public:
inline bool  event(QEvent*  arg__1) { return QSizeGrip::event(arg__1); }
inline void showEvent(QShowEvent*  showEvent) { QSizeGrip::showEvent(showEvent); }
inline void moveEvent(QMoveEvent*  moveEvent) { QSizeGrip::moveEvent(moveEvent); }
inline void hideEvent(QHideEvent*  hideEvent) { QSizeGrip::hideEvent(hideEvent); }
inline void mousePressEvent(QMouseEvent*  arg__1) { QSizeGrip::mousePressEvent(arg__1); }
inline void mouseMoveEvent(QMouseEvent*  arg__1) { QSizeGrip::mouseMoveEvent(arg__1); }
inline void mouseReleaseEvent(QMouseEvent*  mouseEvent) { QSizeGrip::mouseReleaseEvent(mouseEvent); }
inline bool  eventFilter(QObject*  arg__1, QEvent*  arg__2) { return QSizeGrip::eventFilter(arg__1, arg__2); }
inline void paintEvent(QPaintEvent*  arg__1) { QSizeGrip::paintEvent(arg__1); }
};
