...
{
return  (*((PythonQtPublicPromoter_QProcess*)theWrappedObject)).readData(data, maxlen);
}
...
{
return  (*((PythonQtPublicPromoter_QProcess*)theWrappedObject)).writeData(data, len);
}
...
{
 (*((PythonQtPublicPromoter_QProcess*)theWrappedObject)).setupChildProcess();
}
