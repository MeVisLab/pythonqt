...
if (_wrapper) {
  ...
  if (obj && !PythonQtSlotFunction_Check(obj)) {
    static const PythonQtMethodInfo* methodInfo = PythonQtMethodInfo::getCachedMethodInfoFromMetaObjectAndSignature(
      &PythonQtWrapper_QSocketNotifier::staticMetaObject,
      "childEvent(QSocketNotifier*,QChildEvent* )");
...
if (_wrapper) {
  ...
  if (obj && !PythonQtSlotFunction_Check(obj)) {
    static const PythonQtMethodInfo* methodInfo = PythonQtMethodInfo::getCachedMethodInfoFromMetaObjectAndSignature(
      &PythonQtWrapper_QSocketNotifier::staticMetaObject,
      "customEvent(QSocketNotifier*,QEvent* )");
    void* args[2] = {NULL, (void*)&arg__1};
    PyObject* result = PythonQtSignalTarget::call(obj, methodInfo, args, true);
    if (result) { Py_DECREF(result); } 
    Py_DECREF(obj);
...
if (_wrapper) {
  ...
  if (obj && !PythonQtSlotFunction_Check(obj)) {
    static const PythonQtMethodInfo* methodInfo = PythonQtMethodInfo::getCachedMethodInfoFromMetaObjectAndSignature(
      &PythonQtWrapper_QSocketNotifier::staticMetaObject,
      "eventFilter(QSocketNotifier*,QObject* ,QEvent* )");
      bool  returnValue;
...
if (_wrapper) {
  ...
  if (obj && !PythonQtSlotFunction_Check(obj)) {
    static const PythonQtMethodInfo* methodInfo = PythonQtMethodInfo::getCachedMethodInfoFromMetaObjectAndSignature(
      &PythonQtWrapper_QSocketNotifier::staticMetaObject,
      "timerEvent(QSocketNotifier*,QTimerEvent* )");
    void* args[2] = {NULL, (void*)&arg__1};
    PyObject* result = PythonQtSignalTarget::call(obj, methodInfo, args, true);
    if (result) { Py_DECREF(result); } 
    Py_DECREF(obj);
...
{
return  (*((PythonQtPublicPromoter_QSocketNotifier*)theWrappedObject)).event(arg__1);
}
