...
{
return  (*((PythonQtPublicPromoter_QLocalSocket*)theWrappedObject)).writeData(arg__1, arg__2);
}
...
{
return  (*((PythonQtPublicPromoter_QLocalSocket*)theWrappedObject)).readData(arg__1, arg__2);
}
