...
inline bool  promoted_canDropMimeData(const QMimeData*  data, Qt::DropAction  action, int  row, int  column, const QModelIndex&  parent) const { return QAbstractProxyModel::canDropMimeData(data, action, row, column, parent); }
...
inline bool  promoted_dropMimeData(const QMimeData*  data, Qt::DropAction  action, int  row, int  column, const QModelIndex&  parent) { return QAbstractProxyModel::dropMimeData(data, action, row, column, parent); }
...
inline Qt::DropActions  promoted_supportedDragActions() const { return QAbstractProxyModel::supportedDragActions(); }
...
void delete_QAbstractProxyModel(QAbstractProxyModel* obj) { delete obj; } 
   ...
   bool  canDropMimeData(QAbstractProxyModel* theWrappedObject, const QMimeData*  data, Qt::DropAction  action, int  row, int  column, const QModelIndex&  parent) const;
   ...
   bool  dropMimeData(QAbstractProxyModel* theWrappedObject, const QMimeData*  data, Qt::DropAction  action, int  row, int  column, const QModelIndex&  parent);
   ...
   Qt::DropActions  supportedDragActions(QAbstractProxyModel* theWrappedObject) const;
