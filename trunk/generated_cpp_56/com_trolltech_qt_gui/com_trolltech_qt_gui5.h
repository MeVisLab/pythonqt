...
{
public:
    PythonQtShell_QOpenGLContext(QObject*  parent = NULL):QOpenGLContext(parent),_wrapper(NULL) {};
...
public slots:
QOpenGLContext* new_QOpenGLContext(QObject*  parent = NULL);
...
{
public:
    PythonQtShell_QOpenGLShader(QOpenGLShader::ShaderType  type, QObject*  parent = NULL):QOpenGLShader(type, parent),_wrapper(NULL) {};
...
public slots:
QOpenGLShader* new_QOpenGLShader(QOpenGLShader::ShaderType  type, QObject*  parent = NULL);
void delete_QOpenGLShader(QOpenGLShader* obj) { delete obj; } 
   ...
   bool  static_QOpenGLShader_hasOpenGLShaders(QOpenGLShader::ShaderType  type, QOpenGLContext*  context = NULL);
...
{
public:
    PythonQtShell_QOpenGLShaderProgram(QObject*  parent = NULL):QOpenGLShaderProgram(parent),_wrapper(NULL) {};
...
public:
public slots:
QOpenGLShaderProgram* new_QOpenGLShaderProgram(QObject*  parent = NULL);
void delete_QOpenGLShaderProgram(QOpenGLShaderProgram* obj) { delete obj; } 
   ...
   bool  static_QOpenGLShaderProgram_hasOpenGLShaderPrograms(QOpenGLContext*  context = NULL);
...
{
public:
    PythonQtShell_QOpenGLTimeMonitor(QObject*  parent = NULL):QOpenGLTimeMonitor(parent),_wrapper(NULL) {};
...
public:
public slots:
QOpenGLTimeMonitor* new_QOpenGLTimeMonitor(QObject*  parent = NULL);
...
{
public:
    PythonQtShell_QOpenGLTimerQuery(QObject*  parent = NULL):QOpenGLTimerQuery(parent),_wrapper(NULL) {};
...
public:
public slots:
QOpenGLTimerQuery* new_QOpenGLTimerQuery(QObject*  parent = NULL);
...
{
public:
    PythonQtShell_QOpenGLVertexArrayObject(QObject*  parent = NULL):QOpenGLVertexArrayObject(parent),_wrapper(NULL) {};
...
public:
public slots:
QOpenGLVertexArrayObject* new_QOpenGLVertexArrayObject(QObject*  parent = NULL);
...
{
public:
    PythonQtShell_QOpenGLWidget(QWidget*  parent = NULL, Qt::WindowFlags  f = Qt::WindowFlags()):QOpenGLWidget(parent, f),_wrapper(NULL) {};
...
public slots:
QOpenGLWidget* new_QOpenGLWidget(QWidget*  parent = NULL, Qt::WindowFlags  f = Qt::WindowFlags());
...
{
public:
    PythonQtShell_QOpenGLWindow(QOpenGLContext*  shareContext, QOpenGLWindow::UpdateBehavior  updateBehavior = QOpenGLWindow::NoPartialUpdate, QWindow*  parent = NULL):QOpenGLWindow(shareContext, updateBehavior, parent),_wrapper(NULL) {};
    PythonQtShell_QOpenGLWindow(QOpenGLWindow::UpdateBehavior  updateBehavior = QOpenGLWindow::NoPartialUpdate, QWindow*  parent = NULL):QOpenGLWindow(updateBehavior, parent),_wrapper(NULL) {};
...
public slots:
QOpenGLWindow* new_QOpenGLWindow(QOpenGLContext*  shareContext, QOpenGLWindow::UpdateBehavior  updateBehavior = QOpenGLWindow::NoPartialUpdate, QWindow*  parent = NULL);
QOpenGLWindow* new_QOpenGLWindow(QOpenGLWindow::UpdateBehavior  updateBehavior = QOpenGLWindow::NoPartialUpdate, QWindow*  parent = NULL);
