...
virtual bool  chooseContext(const QGLContext*  shareContext = NULL);
...
{ public:
inline bool  promoted_chooseContext(const QGLContext*  shareContext = NULL) { return this->chooseContext(shareContext); }
...
inline bool  py_q_chooseContext(const QGLContext*  shareContext = NULL) { return QGLContext::chooseContext(shareContext); }
inline bool  py_q_create(const QGLContext*  shareContext = NULL) { return QGLContext::create(shareContext); }
...
void delete_QGLContext(QGLContext* obj) { delete obj; } 
   ...
   bool  chooseContext(QGLContext* theWrappedObject, const QGLContext*  shareContext = NULL);
   bool  py_q_chooseContext(QGLContext* theWrappedObject, const QGLContext*  shareContext = NULL){  return (((PythonQtPublicPromoter_QGLContext*)theWrappedObject)->py_q_chooseContext(shareContext));}
   ...
   bool  create(QGLContext* theWrappedObject, const QGLContext*  shareContext = NULL);
   bool  py_q_create(QGLContext* theWrappedObject, const QGLContext*  shareContext = NULL){  return (((PythonQtPublicPromoter_QGLContext*)theWrappedObject)->py_q_create(shareContext));}
...
void delete_QGLFunctions(QGLFunctions* obj) { delete obj; } 
   ...
   void initializeGLFunctions(QGLFunctions* theWrappedObject, const QGLContext*  context = NULL);
...
{
public:
    PythonQtShell_QGLPixelBuffer(const QSize&  size, const QGLFormat&  format = QGLFormat::defaultFormat(), QGLWidget*  shareWidget = NULL):QGLPixelBuffer(size, format, shareWidget),_wrapper(NULL) {};
    PythonQtShell_QGLPixelBuffer(int  width, int  height, const QGLFormat&  format = QGLFormat::defaultFormat(), QGLWidget*  shareWidget = NULL):QGLPixelBuffer(width, height, format, shareWidget),_wrapper(NULL) {};
...
public:
public slots:
QGLPixelBuffer* new_QGLPixelBuffer(const QSize&  size, const QGLFormat&  format = QGLFormat::defaultFormat(), QGLWidget*  shareWidget = NULL);
QGLPixelBuffer* new_QGLPixelBuffer(int  width, int  height, const QGLFormat&  format = QGLFormat::defaultFormat(), QGLWidget*  shareWidget = NULL);
...
{
public:
    PythonQtShell_QGLShader(QGLShader::ShaderType  type, QObject*  parent = NULL):QGLShader(type, parent),_wrapper(NULL) {};
    PythonQtShell_QGLShader(QGLShader::ShaderType  type, const QGLContext*  context, QObject*  parent = NULL):QGLShader(type, context, parent),_wrapper(NULL) {};
...
public slots:
QGLShader* new_QGLShader(QGLShader::ShaderType  type, QObject*  parent = NULL);
QGLShader* new_QGLShader(QGLShader::ShaderType  type, const QGLContext*  context, QObject*  parent = NULL);
void delete_QGLShader(QGLShader* obj) { delete obj; } 
   ...
   bool  static_QGLShader_hasOpenGLShaders(QGLShader::ShaderType  type, const QGLContext*  context = NULL);
...
{
public:
    PythonQtShell_QGLShaderProgram(QObject*  parent = NULL):QGLShaderProgram(parent),_wrapper(NULL) {};
    PythonQtShell_QGLShaderProgram(const QGLContext*  context, QObject*  parent = NULL):QGLShaderProgram(context, parent),_wrapper(NULL) {};
...
public:
public slots:
QGLShaderProgram* new_QGLShaderProgram(QObject*  parent = NULL);
QGLShaderProgram* new_QGLShaderProgram(const QGLContext*  context, QObject*  parent = NULL);
void delete_QGLShaderProgram(QGLShaderProgram* obj) { delete obj; } 
   ...
   bool  static_QGLShaderProgram_hasOpenGLShaderPrograms(const QGLContext*  context = NULL);
...
{
public:
    PythonQtShell_QGLWidget(QGLContext*  context, QWidget*  parent = NULL, const QGLWidget*  shareWidget = NULL, Qt::WindowFlags  f = Qt::WindowFlags()):QGLWidget(context, parent, shareWidget, f),_wrapper(NULL) {};
    PythonQtShell_QGLWidget(QWidget*  parent = NULL, const QGLWidget*  shareWidget = NULL, Qt::WindowFlags  f = Qt::WindowFlags()):QGLWidget(parent, shareWidget, f),_wrapper(NULL) {};
    PythonQtShell_QGLWidget(const QGLFormat&  format, QWidget*  parent = NULL, const QGLWidget*  shareWidget = NULL, Qt::WindowFlags  f = Qt::WindowFlags()):QGLWidget(format, parent, shareWidget, f),_wrapper(NULL) {};
...
public:
public slots:
QGLWidget* new_QGLWidget(QGLContext*  context, QWidget*  parent = NULL, const QGLWidget*  shareWidget = NULL, Qt::WindowFlags  f = Qt::WindowFlags());
QGLWidget* new_QGLWidget(QWidget*  parent = NULL, const QGLWidget*  shareWidget = NULL, Qt::WindowFlags  f = Qt::WindowFlags());
QGLWidget* new_QGLWidget(const QGLFormat&  format, QWidget*  parent = NULL, const QGLWidget*  shareWidget = NULL, Qt::WindowFlags  f = Qt::WindowFlags());
