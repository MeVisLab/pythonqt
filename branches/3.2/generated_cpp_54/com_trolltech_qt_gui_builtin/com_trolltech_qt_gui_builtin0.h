...
enum StyleStrategy{
  PreferDefault = QFont::PreferDefault,   PreferBitmap = QFont::PreferBitmap,   PreferDevice = QFont::PreferDevice,   PreferOutline = QFont::PreferOutline,   ForceOutline = QFont::ForceOutline,   PreferMatch = QFont::PreferMatch,   PreferQuality = QFont::PreferQuality,   PreferAntialias = QFont::PreferAntialias,   NoAntialias = QFont::NoAntialias,   OpenGLCompatible = QFont::OpenGLCompatible,   ForceIntegerMetrics = QFont::ForceIntegerMetrics,   NoSubpixelAntialias = QFont::NoSubpixelAntialias,   NoFontMerging = QFont::NoFontMerging};
enum Weight{
...
void delete_QPixmap(QPixmap* obj) { delete obj; } 
   ...
   QPixmap  static_QPixmap_fromImageInPlace(QImage&  image, Qt::ImageConversionFlags  flags = Qt::AutoColor);
