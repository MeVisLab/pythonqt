...
public:
    ...
    PythonQtShell_QCamera(const QByteArray&  device, QObject*  parent = 0):QCamera(device, parent),_wrapper(NULL) {};
...
QCamera* new_QCamera(const QByteArray&  device, QObject*  parent = 0);
