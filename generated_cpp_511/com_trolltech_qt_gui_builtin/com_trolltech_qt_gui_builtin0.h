...
enum StyleHint{
  Helvetica = QFont::Helvetica,   Times = QFont::Times,   Courier = QFont::Courier,   OldEnglish = QFont::OldEnglish,   System = QFont::System,   AnyStyle = QFont::AnyStyle,   Cursive = QFont::Cursive,   Monospace = QFont::Monospace,   Fantasy = QFont::Fantasy};
enum StyleStrategy{
