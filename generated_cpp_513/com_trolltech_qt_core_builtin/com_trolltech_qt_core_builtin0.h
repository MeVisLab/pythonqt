...
void delete_QLocale(QLocale* obj) { delete obj; }
   ...
   long  toLong(QLocale* theWrappedObject, const QStringRef&  s, bool*  ok = nullptr) const;
   ...
   ulong  toULong(QLocale* theWrappedObject, const QStringRef&  s, bool*  ok = nullptr) const;
