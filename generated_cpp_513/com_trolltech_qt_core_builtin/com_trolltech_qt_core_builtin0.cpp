...
long  PythonQtWrapper_QLocale::toLong(QLocale* theWrappedObject, const QStringRef&  s, bool*  ok) const
{
  return ( theWrappedObject->toLong(s, ok));
}
...
ulong  PythonQtWrapper_QLocale::toULong(QLocale* theWrappedObject, const QStringRef&  s, bool*  ok) const
{
  return ( theWrappedObject->toULong(s, ok));
}
