...
class PQCppObjectWrapper : public QObject
{
  Q_OBJECT
public:
  PQCppObjectWrapper(void* ptr) { _ptr = (PQCppObject*)ptr; }
...
public Q_SLOTS:
  PQCppObjectNoWrap* new_PQCppObjectNoWrap() { return new PQCppObjectNoWrap(0); }
  PQCppObjectNoWrap* new_PQCppObjectNoWrap(const PQCppObjectNoWrap& /*other*/) { return new PQCppObjectNoWrap(1); }
  PQCppObjectNoWrap* new_PQCppObjectNoWrap(double /*value*/) { return new PQCppObjectNoWrap(2); }
...
public Q_SLOTS:
  PQCppObject2* new_PQCppObject2() { return new PQCppObject2(); }
...
public:
  ...
  float floatProp() const
  {
    _called = true;
    return _floatProp;
  }
  void setFloatProp(float value)
  {
    _called = true;
    _floatProp = value;
  }

  QVariantList variantListProp() const
  {
    _called = true;
    return _variantListProp;
  }
  void setVariantListProp(const QVariantList& value)
  {
    _called = true;
    _variantListProp = value;
  }

  QVariantMap variantMapProp() const
  {
    _called = true;
    return _variantMapProp;
  }
  void setVariantMapProp(const QVariantMap& value)
  {
    _called = true;
    _variantMapProp = value;
  }

  QVariant variantProp() const
  {
    _called = true;
    return _variantProp;
  }
  void setVariantProp(const QVariant& value)
  {
    _called = true;
    _variantProp = value;
  }

  QObject* qObjectProp() const
  {
    _called = true;
    return _qObjectProp;
  }
  void setQObjectProp(QObject* value)
  {
    _called = true;
    _qObjectProp = value;
  }

  QObjectList qObjectListProp() const
  {
    _called = true;
    return _qObjectListProp;
  }
  void setQObjectListProp(const QObjectList& value)
  {
    _called = true;
    _qObjectListProp = value;
  }

  QSize sizeProp() const
  {
    _called = true;
    return _sizeProp;
  }
  void setSizeProp(const QSize& value)
  {
    _called = true;
    _sizeProp = value;
  }
...
public Q_SLOTS:
  ...
  void overload(const QString& /*str*/)
  {
    _calledOverload = 3;
    _called = true;
  }
  void overload(const QStringList& /*str*/)
  {
    _calledOverload = 4;
    _called = true;
  }
  void overload(QObject* /*str*/)
  {
    _calledOverload = 5;
    _called = true;
  }
  void overload(float /*a*/, int /*b*/)
  {
    _calledOverload = 6;
    _called = true;
  }
  ...
  int keywordInt(int i, const QVariantMap& kwargs = QVariantMap())
  {
    _called = true;
    return (i + kwargs["value"].toInt());
  }
  int keywordOnly(const QVariantMap& kwargs = QVariantMap())
  {
    _called = true;
    return kwargs.count();
  }
  ...
  unsigned int getUInt(unsigned int a)
  {
    _called = true;
    return a;
  }
  ...
  unsigned char getUChar(unsigned char a)
  {
    _called = true;
    return a;
  }
  ...
  unsigned long getULong(unsigned long a)
  {
    _called = true;
    return a;
  }
  ...
  unsigned short getUShort(unsigned short a)
  {
    _called = true;
    return a;
  }
  QChar getQChar(QChar a)
  {
    _called = true;
    return a;
  }
  qint64 getLongLong(qint64 a)
  {
    _called = true;
    return a;
  }
  quint64 getULongLong(quint64 a)
  {
    _called = true;
    return a;
  }
  ...
  QStringList getQStringList(const QStringList& l)
  {
    _called = true;
    return l;
  }
  QVariant getQVariant(const QVariant& var)
  {
    _called = true;
    return var;
  }

  QList<int> getQListInt()
  {
    _called = true;
    return QList<int>() << 1 << 2 << 3;
  }
  QList<unsigned int> getQListUnsignedInt()
  {
    _called = true;
    return QList<unsigned int>() << 1 << 2 << 3;
  }
  QList<qreal> getQListqreal()
  {
    _called = true;
    return QList<qreal>() << 1.1 << 2.2 << 3.3;
  }
  QList<float> getQListfloat()
  {
    _called = true;
    return QList<float>() << 1 << 2 << 3;
  }
  QList<double> getQListdouble()
  {
    _called = true;
    return QList<double>() << 1.1 << 2.2 << 3.3;
  }
  QList<quint64> getQListquint64()
  {
    _called = true;
    return QList<quint64>() << 1 << 2 << 3;
  }
  QList<qint64> getQListqint64()
  {
    _called = true;
    return QList<qint64>() << 1 << 2 << 3;
  }
  ...
  QList<QSize> getQListQSize()
  {
    _called = true;
    return QList<QSize>() << QSize(1, 2) << QSize(3, 4);
  }
  QList<QSize> getQListQSize(const QList<QSize>& list)
  {
    _called = true;
    return list;
  }

  QList<Qt::DayOfWeek> getQListDayOfWeek(const QList<Qt::DayOfWeek>& days)
  {
    _called = true;
    return days;
  }

  QMap<int, QVariant> getQMapIntVariant(const QMap<int, QVariant>& map)
  {
    _called = true;
    return map;
  }
  QMap<int, QString> getQMapIntString(const QMap<int, QString>& map)
  {
    _called = true;
    return map;
  }

  QVector<QPair<double, QColor>> getQVectorQPair1(const QVector<QPair<double, QColor>>& list)
  {
    _called = true;
    return list;
  }
  QVector<QPair<qreal, QColor>> getQVectorQPair2(const QVector<QPair<qreal, QColor>>& list)
  {
    _called = true;
    return list;
  }

  QPair<double, QColor> getQPair(const QPair<double, QColor>& pair)
  {
    _called = true;
    return pair;
  }

  QPair<double, QVariant> getQPairVariant(const QPair<double, QVariant>& pair)
  {
    _called = true;
    return pair;
  }
  ...
  QColor getQColor1(const QColor& var)
  {
    _called = true;
    return var;
  }
  QColor getQColor2(QColor& var)
  {
    _called = true;
    return var;
  }
  QColor getQColor3(QColor* col)
  {
    _called = true;
    return *col;
  }
  QColor getQColor4(const QVariant& color)
  {
    _called = true;
    return qvariant_cast<QColor>(color);
  }
  QColor* getQColor5()
  {
    _called = true;
    static QColor c(1, 2, 3);
    return &c;
  }
  ...
  QVariant getPyObjectFromVariant2(const QVariant& val)
  {
    _called = true;
    return val;
  }
  ...
  PythonQtTestSlotCallingHelper* getTestObject(PythonQtTestSlotCallingHelper* obj)
  {
    _called = true;
    return obj;
  }
  //! testing inheritance checking
  QObject* getQObject(QObject* obj)
  {
    _called = true;
    return obj;
  }
  QWidget* getQWidget(QWidget* obj)
  {
    _called = true;
    return obj;
  }
  //! testing if an object that was not wrapped is wrapped earlier is wrapped correctly
  QObject* getNewObject()
  {
    _called = true;
    return new PythonQtTestSlotCallingHelper(NULL);
  }

  QVariantList getMultiArgs(int a, double b, const QString& str)
  {
    _called = true;
    return (QVariantList() << a << b << str);
  }

  //! cpp wrapper factory test
  PQCppObject* createPQCppObject(int h)
  {
    _called = true;
    return new PQCppObject(h);
  }

  //! cpp wrapper factory test
  PQCppObject* getPQCppObject(PQCppObject* p)
  {
    _called = true;
    return p;
  }
  ...
  //! cpp wrapper factory test
  PQCppObjectNoWrap* createPQCppObjectNoWrap(int h)
  {
    _called = true;
    return new PQCppObjectNoWrap(h);
  }

  //! cpp wrapper factory test
  PQCppObjectNoWrap* getPQCppObjectNoWrap(PQCppObjectNoWrap* p)
  {
    _called = true;
    return p;
  }
  ...
  PQCppObjectNoWrap getPQCppObjectNoWrapAsValue()
  {
    _called = true;
    return PQCppObjectNoWrap(47);
  }

  PQUnknownButRegisteredValueObject getUnknownButRegisteredValueObjectAsValue()
  {
    _called = true;
    return PQUnknownButRegisteredValueObject();
  }
  PQUnknownValueObject getUnknownValueObjectAsValue()
  {
    _called = true;
    return PQUnknownValueObject();
  }

  PQUnknownButRegisteredValueObject* getUnknownButRegisteredValueObjectAsPtr()
  {
    _called = true;
    return new PQUnknownButRegisteredValueObject();
  }
  PQUnknownValueObject* getUnknownValueObjectAsPtr()
  {
    _called = true;
    return new PQUnknownValueObject();
  }

  ClassA* getClassAPtr(ClassA* o)
  {
    _called = true;
    return o;
  }
  ClassB* getClassBPtr(ClassB* o)
  {
    _called = true;
    return o;
  }
  ClassC* getClassCPtr(ClassC* o)
  {
    _called = true;
    return o;
  }
  ClassD* getClassDPtr(ClassD* o)
  {
    _called = true;
    return o;
  }
  ...
  ClassA* createClassCAsA()
  {
    _called = true;
    return new ClassC;
  }
  ClassB* createClassCAsB()
  {
    _called = true;
    return new ClassC;
  }
  ClassA* createClassDAsA()
  {
    _called = true;
    return new ClassD;
  }
  ClassB* createClassDAsB()
  {
    _called = true;
    return new ClassD;
  }

  QColor setAutoConvertColor(const QColor& color)
  {
    _called = true;
    return color;
  }
  QBrush setAutoConvertBrush(const QBrush& brush)
  {
    _called = true;
    return brush;
  }
  QPen setAutoConvertPen(const QPen& pen)
  {
    _called = true;
    return pen;
  }
  QCursor setAutoConvertCursor(const QCursor& cursor)
  {
    _called = true;
    return cursor;
  }
...
public Q_SLOTS:
  ...
  bool emitIntSignal(int a)
  {
    _passed = false;
    emit intSignal(a);
    return _passed;
  }
  bool emitFloatSignal(float a)
  {
    _passed = false;
    emit floatSignal(a);
    return _passed;
  }
  bool emitEnumSignal(PQCppObject2::TestEnumFlag flag)
  {
    _passed = false;
    emit enumSignal(flag);
    return _passed;
  }

  bool emitVariantSignal(const QVariant& v)
  {
    _passed = false;
    emit variantSignal(v);
    return _passed;
  }
  QVariant expectedVariant() { return _v; }
  void setExpectedVariant(const QVariant& v) { _v = v; }

  bool emitComplexSignal(int a, float b, const QStringList& l, QObject* obj)
  {
    _passed = false;
    emit complexSignal(a, b, l, obj);
    return _passed;
  }

  bool emitSignal1(int a)
  {
    _passed = false;
    emit signal1(a);
    return _passed;
  }
  bool emitSignal2(const QString& s)
  {
    _passed = false;
    emit signal2(s);
    return _passed;
  }
  bool emitSignal3(float a)
  {
    _passed = false;
    emit signal3(a);
    return _passed;
